...
// 0: all/assembled, 1: fixture-print, 2: plate-print, 3: bracket-print, 4: pegs
loc = 5;
yl = 170;
...
// fixture();
atrans(loc, [[0,0,0], 0]) fixhalf(1);
atrans(loc, [[0,0,0], [0, -5, 0, [180, 0, 0]]]) fixhalf(2);
